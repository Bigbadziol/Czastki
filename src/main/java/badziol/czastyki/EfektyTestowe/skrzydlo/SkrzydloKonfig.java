...
public class SkrzydloKonfig {
    ...
    private  final ArrayList<String> skrzydloWzorNiebezpiecznyLot = new ArrayList<>();
    ...
    public SkrzydloKonfig() {
        ...
        skrzydloWzorNiebezpiecznyLot.add("o,x,x,x,x,x,x,x,x,x");
        skrzydloWzorNiebezpiecznyLot.add("o,x,x,x,x,x,x,x,x,x");
        skrzydloWzorNiebezpiecznyLot.add("o,x,x,x,x,x,x,x,x,x");
        skrzydloWzorNiebezpiecznyLot.add("-,o,x,x,x,x,x,x,x,x");
